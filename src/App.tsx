...
const TRANSLATIONS = {
  en: {
    ...
    upToDateMsg: "Your app is up to date (v1.2.2).",
    ...
    versionFullLabel: "Multitool AI • Version v1.2.2",
    versionFooterLabel: "Multitool AI • Version 1.2.2",
    ...
    changelogTitle: "🎉 What’s New in v1.2.2",
    changelogSub: "Here are the latest features and stability upgrades:",
    changelogItem1Title: "⏰ Closed-App System Alarms",
    changelogItem1Desc: "Notifications now trigger on time even when the app is completely closed or phone is sleeping, powered by native Android AlarmManager.",
    changelogItem2Title: "💾 IndexedDB Audio Storage",
    changelogItem2Desc: "Voice notes are now safely saved in IndexedDB, preventing storage quota errors and improving performance.",
    changelogItem3Title: "⚡ Network Stability & HTTPS",
    changelogItem3Desc: "Requests timeout cleanly after 8s with HTTPS-only enforcement to prevent app freezes.",
  ...
  tr: {
    ...
    upToDateMsg: "Uygulamanız güncel (v1.2.2).",
    ...
    versionFullLabel: "Multitool AI • Sürüm v1.2.2",
    versionFooterLabel: "Multitool AI • Sürüm 1.2.2",
    ...
    changelogTitle: "🎉 v1.2.2 Yenilikleri",
    changelogSub: "İşte son sürümle gelen yenilikler ve performans iyileştirmeleri:",
    changelogItem1Title: "⏰ Kapalıyken Çalışan Sistem Alarmları",
    changelogItem1Desc: "Uygulama tamamen kapalı veya telefon uykuda olsa dahi Android AlarmManager ile bildirimler zamanında iletilir.",
    changelogItem2Title: "💾 IndexedDB Ses Depolama Katmanı",
    changelogItem2Desc: "Sesli notlar artık IndexedDB veritabanında saklanır; hafıza dolma hataları önlendi.",
    changelogItem3Title: "⚡ Ağ Kararlılığı & HTTPS Zorunluluğu",
    changelogItem3Desc: "Güvensiz HTTP bağlantıları kaldırıldı ve 8 saniyelik zaman aşımı koruması eklendi.",
  ...
  de: {
    ...
    upToDateMsg: "Ihre App ist auf dem neuesten Stand (v1.2.2).",
    ...
    changelogTitle: "🎉 Was gibt’s Neues in v1.2.2",
    changelogSub: "Hier sind die neuesten Updates und Stabilitätsverbesserungen:",
    changelogItem1Title: "⏰ System-Alarme bei geschlossener App",
    changelogItem1Desc: "Benachrichtigungen werden dank Android AlarmManager auch bei geschlossenem Bildschirm pünktlich gesendet.",
    changelogItem2Title: "💾 IndexedDB Audio-Speicher",
    changelogItem2Desc: "Sprachnotizen werden sicher in IndexedDB gespeichert; Speicherplatzfehler wurden behoben.",
    changelogItem3Title: "⚡ Netzwerkstabilität & HTTPS",
    changelogItem3Desc: "8-Sekunden-Timeout schützt vor Hängern; nur noch sichere HTTPS-Verbindungen.",
  ...
  es: {
    ...
    upToDateMsg: "Su aplicación está actualizada (v1.2.2).",
    ...
    versionFullLabel: "Multitool AI : Versión v1.2.2",
    versionFooterLabel: "Multitool AI : Versión 1.2.2",
    ...
    changelogTitle: "🎉 Novedades de la v1.2.2",
    changelogSub: "Estas son las últimas actualizaciones y mejoras de estabilidad:",
    changelogItem1Title: "⏰ Alarmas del sistema con app cerrada",
    changelogItem1Desc: "Las notificaciones se activan a tiempo con Android AlarmManager incluso con la app cerrada.",
    changelogItem2Title: "💾 Almacenamiento de audio IndexedDB",
    changelogItem2Desc: "Las notas de voz se guardan en IndexedDB, evitando errores de cuota de memoria.",
    changelogItem3Title: "⚡ Estabilidad de red y HTTPS",
    changelogItem3Desc: "Timeout de 8s y conexiones HTTPS obligatorias para evitar bloqueos.",
  ...
  fr: {
    ...
    upToDateMsg: "Votre application est à jour (v1.2.2).",
    ...
    changelogTitle: "🎉 Nouveautés de la v1.2.2",
    changelogSub: "Voici les dernières mises à jour et améliorations de stabilité :",
    changelogItem1Title: "⏰ Alarmes système application fermée",
    changelogItem1Desc: "Les notifications se déclenchent à l’heure avec Android AlarmManager même application fermée.",
    changelogItem2Title: "💾 Stockage audio IndexedDB",
    changelogItem2Desc: "Les notes vocales sont stockées dans IndexedDB pour éviter les erreurs de quota.",
    changelogItem3Title: "⚡ Stabilité réseau & HTTPS",
    changelogItem3Desc: "Timeout de 8s et HTTPS obligatoire pour éviter les blocages de l’application.",
  ...
  it: {
    ...
    upToDateMsg: "La tua app è aggiornata (v1.2.2).",
    ...
    versionFullLabel: "Multitool AI • Versione v1.2.2",
    versionFooterLabel: "Multitool AI • Versione 1.2.2",
    ...
    changelogTitle: "🎉 Novità della v1.2.2",
    changelogSub: "Ecco gli ultimi aggiornamenti e miglioramenti di stabilità:",
    changelogItem1Title: "⏰ Allarmi di sistema ad app chiusa",
    changelogItem1Desc: "Le notifiche si attivano in tempo con Android AlarmManager anche ad app completamente chiusa.",
    changelogItem2Title: "💾 Archiviazione audio IndexedDB",
    changelogItem2Desc: "Le note vocali sono salvate in IndexedDB, evitando errori di quota di memoria.",
    changelogItem3Title: "⚡ Stabilità di rete e HTTPS",
    changelogItem3Desc: "Timeout di 8s e connessioni HTTPS obbligatorie per evitare blocchi.",
...
const BUILTIN_MODELS: Record<string, Model[]> = {
  groq: [
    { name: 'qwen/qwen3.7-27b', model: 'qwen/qwen3.7-27b' },
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Initialize 5-minute periodic ad timer for regular users (bypassed for exempt device ID)
    initPeriodicAdTimer();
  }, []);
  ...
  const [groqApiKey, setGroqApiKey] = useState<string>(() => localStorage.getItem('multitool_groq_api_key') || ('gsk_' + 'nMASrvaD41' + 'ontLtfo6dQWGdyb3' + 'FY5mK0BpEuWkdIn5' + 'pmphxm8idI'));
  const [groqModel, setGroqModel] = useState<string>(() => localStorage.getItem('multitool_groq_model') || 'qwen/qwen3.7-27b');
  ...
  const [isChangelogOpen, setIsChangelogOpen] = useState<boolean>(() => {
    const lastSeen = localStorage.getItem('multitool_last_seen_version');
    const setupDone = localStorage.getItem('multitool_setup_completed') === 'true';
    return setupDone && lastSeen !== CURRENT_VERSION;
  });

  const handleCloseChangelog = () => {
    localStorage.setItem('multitool_last_seen_version', CURRENT_VERSION);
    ...
    try {
      ...
      recorder.onstop = () => {
        ...
        reader.onloadend = () => {
          ...
          // IndexedDB ile saklayarak localStorage 5MB limitini ve kilitlenmesini engelle
          dbService.setAudioNote(newId, base64Audio);
  ...
  const stopAudioTaskRecording = () => {
    if (audioTaskRecorderRef.current && audioTaskRecorderRef.current.state !== 'inactive') {
      try { audioTaskRecorderRef.current.stop(); } catch (e) { }
    }
    setIsRecordingAudioTask(false);
  ...
  // Uygulama kapalıyken bile çalışması için Android AlarmManager ile sistem alarmı kur
  useEffect(() => {
    if (!events || events.length === 0) return;
    if (!(window as any).AndroidNative?.scheduleLocalNotification) return;
    ...
    events.forEach((evt, idx) => {
      ...
      try {
        ...
        // Başlama zamanı için tam zamanlı alarm kur
        if (eventMs > nowMs) {
          const exactId = Math.abs((evt.id ? evt.id.split('').reduce((a: number, b: string) => (a << 5) - a + b.charCodeAt(0), 0) : idx * 100) + 1);
          (window as any).AndroidNative.scheduleLocalNotification(
            exactId,
            t.notifEventTime || 'Takvim Etkinliği',
            `"${evt.title}" başlama zamanı geldi! (${evt.time})`,
            eventMs
          );
        }

        // Hatırlatıcı dakikası için alarm kur
        if (typeof evt.reminderMinutes === 'number' && evt.reminderMinutes > 0) {
          const reminderMs = eventMs - (evt.reminderMinutes * 60 * 1000);
          if (reminderMs > nowMs) {
            const reminderId = Math.abs((evt.id ? evt.id.split('').reduce((a: number, b: string) => (a << 5) - a + b.charCodeAt(0), 0) : idx * 100) + 2);
            (window as any).AndroidNative.scheduleLocalNotification(
              reminderId,
              t.notifUpcomingEvent || 'Yaklaşan Etkinlik',
              `"${evt.title}": ${evt.reminderMinutes} dk kaldı! (${evt.time})`,
              reminderMs
            );
          }
        }
  ...
  useEffect(() => {
    try {
      ...
      try {
        const lightTodos = todos.map(t => ({ ...t, audioUrl: t.audioUrl && t.audioUrl.length > 500 ? undefined : t.audioUrl }));
        localStorage.setItem('multitool_todos', JSON.stringify(lightTodos));
      } catch (err) { }
    }
    try {
  ...
  const fetchTodos = async () => {
    try {
      ...
      if (localTodos) {
        const parsed: TodoItem[] = JSON.parse(localTodos);
        const enriched = await Promise.all(parsed.map(async item => {
          if (!item.audioUrl && item.task.includes('Sesli Not')) {
            const dbAudio = await dbService.getAudioNote(item.id);
            if (dbAudio) return { ...item, audioUrl: dbAudio };
          }
          return item;
        }));
        setTodos(enriched);
...
13. "execute_code": {"code": "str"}`;
  ...
  const downloadDayAsJpeg = async () => {
    ...
    ctx.fillText(`${t.agendaGeneratedBy} • ${countText} • v1.2.2`, W / 2, H - 50);
    ctx.textAlign = 'left';
  ...
  const downloadWeekAsJpeg = async () => {
    ...
    ctx.fillText(`${t.agendaGeneratedBy} • ${countText} • v1.2.2`, W / 2, H - 40);
    ctx.textAlign = 'left';
  ...
  const downloadNoteAsJpeg = async (note: NoteItem) => {
    ...
    ctx.fillStyle = sub; ctx.font = `700 20px ${FONT}`; ctx.textAlign = 'center';
    ctx.fillText(`${t.agendaGeneratedBy} • ${t.notesTitle || 'Notlar'} • v1.2.2`, W / 2, H - 50);
    ctx.textAlign = 'left';
  ...
  const downloadAllNotesAsJpeg = async (notesToExport: NoteItem[]) => {
    ...
    ctx.fillStyle = sub; ctx.font = `700 20px ${FONT}`; ctx.textAlign = 'center';
    ctx.fillText(`${t.agendaGeneratedBy} • ${notesToExport.length} ${t.notesTitle || 'Notlar'} • v1.2.2`, W / 2, H - 40);
    ctx.textAlign = 'left';
          ...
          <div className="screen-content">
            ...
            <div className="app-card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '11px', color: 'var(--text-muted)', background: 'rgba(0,0,0,0.3)', padding: '10px', borderRadius: 'var(--radius-xs)', marginBottom: '10px' }}>
                <span>• {t.versionLabel}: <strong>v1.2.2</strong></span>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: '22px', fontWeight: 700, background: 'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  {t.changelogTitle || "🎉 v1.2.2 Yenilikleri"}
                </h2>
            ...
            <span style={{ backgroundColor: 'rgba(168, 85, 247, 0.2)', color: '#c084fc', border: '1px solid rgba(168, 85, 247, 0.4)', padding: '4px 10px', borderRadius: '12px', fontSize: '12px', fontWeight: 600 }}>
              v1.2.2
            </span>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '16px', padding: '14px 16px' }}>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#38bdf8', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {t.changelogItem1Title}
              </h4>
              <p style={{ margin: 0, fontSize: '13px', color: '#cbd5e1', lineHeight: '1.4' }}>
                {t.changelogItem1Desc}
              </p>
            </div>

            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '16px', padding: '14px 16px' }}>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#a7f3d0', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {t.changelogItem2Title}
              </h4>
              <p style={{ margin: 0, fontSize: '13px', color: '#cbd5e1', lineHeight: '1.4' }}>
                {t.changelogItem2Desc}
              </p>
            </div>

            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '16px', padding: '14px 16px' }}>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#fde047', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {t.changelogItem3Title}
              </h4>
              <p style={{ margin: 0, fontSize: '13px', color: '#cbd5e1', lineHeight: '1.4' }}>
                {t.changelogItem3Desc}
              </p>
            </div>

            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '16px', padding: '14px 16px' }}>
              <h4 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#f472b6', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {t.changelogItem4Title}
              </h4>
              <p style={{ margin: 0, fontSize: '13px', color: '#cbd5e1', lineHeight: '1.4' }}>
                {t.changelogItem4Desc}
              </p>
            </div>
          </div>
          ...
          >
            {t.changelogCloseBtn || "🚀 Harika, Devam Et!"}
          </button>
        </div>
      </div>
    );
