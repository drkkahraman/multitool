...
const TRANSLATIONS = {
  en: {
    ...
    upToDateMsg: "Your app is up to date (v1.2.3).",
    ...
    versionFullLabel: "Multitool AI • Version v1.2.3",
    versionFooterLabel: "Multitool AI • Version 1.2.3",
    ...
    changelogTitle: "🎉 What’s New in v1.2.3",
  ...
  tr: {
    ...
    upToDateMsg: "Uygulamanız güncel (v1.2.3).",
    ...
    versionFullLabel: "Multitool AI • Sürüm v1.2.3",
    versionFooterLabel: "Multitool AI • Sürüm 1.2.3",
    ...
    changelogTitle: "🎉 v1.2.3 Yenilikleri",
  ...
  de: {
    ...
    upToDateMsg: "Ihre App ist auf dem neuesten Stand (v1.2.3).",
    ...
    changelogTitle: "🎉 Was gibt’s Neues in v1.2.3",
  ...
  es: {
    ...
    upToDateMsg: "Su aplicación está actualizada (v1.2.3).",
    ...
    versionFullLabel: "Multitool AI : Versión v1.2.3",
    versionFooterLabel: "Multitool AI : Versión 1.2.3",
    ...
    changelogTitle: "🎉 Novedades de la v1.2.3",
  ...
  fr: {
    ...
    upToDateMsg: "Votre application est à jour (v1.2.3).",
    ...
    changelogTitle: "🎉 Nouveautés de la v1.2.3",
  ...
  it: {
    ...
    upToDateMsg: "La tua app è aggiornata (v1.2.3).",
    ...
    versionFullLabel: "Multitool AI • Versione v1.2.3",
    versionFooterLabel: "Multitool AI • Versione 1.2.3",
    ...
    changelogTitle: "🎉 Novità della v1.2.3",
...
13. "execute_code": {"code": "str"}`;
  ...
  const downloadDayAsJpeg = async () => {
    ...
    ctx.fillText(`${t.agendaGeneratedBy} • ${countText} • v1.2.3`, W / 2, H - 50);
    ctx.textAlign = 'left';
  ...
  const downloadWeekAsJpeg = async () => {
    ...
    ctx.fillText(`${t.agendaGeneratedBy} • ${countText} • v1.2.3`, W / 2, H - 40);
    ctx.textAlign = 'left';
  ...
  const downloadNoteAsJpeg = async (note: NoteItem) => {
    ...
    ctx.fillStyle = sub; ctx.font = `700 20px ${FONT}`; ctx.textAlign = 'center';
    ctx.fillText(`${t.agendaGeneratedBy} • ${t.notesTitle || 'Notlar'} • v1.2.3`, W / 2, H - 50);
    ctx.textAlign = 'left';
  ...
  const downloadAllNotesAsJpeg = async (notesToExport: NoteItem[]) => {
    ...
    ctx.fillStyle = sub; ctx.font = `700 20px ${FONT}`; ctx.textAlign = 'center';
    ctx.fillText(`${t.agendaGeneratedBy} • ${notesToExport.length} ${t.notesTitle || 'Notlar'} • v1.2.3`, W / 2, H - 40);
    ctx.textAlign = 'left';
          ...
          <div className="screen-content">
            ...
            <div className="app-card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', fontSize: '11px', color: 'var(--text-muted)', background: 'rgba(0,0,0,0.3)', padding: '10px', borderRadius: 'var(--radius-xs)', marginBottom: '10px' }}>
                <span>• {t.versionLabel}: <strong>v1.2.3</strong></span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: '22px', fontWeight: 700, background: 'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  {t.changelogTitle || "🎉 v1.2.3 Yenilikleri"}
                </h2>
